...
$count=0;
$user_data = check_login($con);
$sql=$con->adb->cancelorders->find(['userid'=>$user_data['tid']]);
//$sql=$con->adb->cancelorders->distinct("orderid1", ['userid' =>$user_data['tid']]);
//$sql=$adb->command(array("distinct" => "cancelorders", "userid" => "type"));
...
foreach($sql as $r1)
{
	...
	$sql33=$con->adb->cancelorders->find(['orderid1'=>$r1['orderid1']]);
